package com.financial.common.mq.config;
...
public class DirectRabbitConfig {
    ...
    DirectExchange directExchange(){
        ...
        return new DirectExchange("finance.exchange",true,false);
    }
    //绑定交换机和队列
    @Bean
    Binding bindingDirect(){
        //bind队列to交换机中with路由key（routing key）
        return BindingBuilder.bind(directQueue()).to(directExchange()).with("finance.routingKey");
    }
}
