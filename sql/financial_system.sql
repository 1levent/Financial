...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,'admin', '系统管理员', '00', '1993262229@qq.com', '13580147042', '1', '', '123456', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '管理员');
insert into sys_user values(2,'levent', '乐文', '00', '1993262229@qq.com',  '13580147042', '1', '', '123456', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '测试员');
...
-- 初始化-公告信息表数据
-- ----------------------------
insert into sys_notice values('1', '温馨提醒：2025-03-24 新版本发布啦', '2', '新版本内容', '0', 'admin', sysdate(), '', null, '管理员');
insert into sys_notice values('2', '维护通知：2018-03-24 系统凌晨维护', '1', '维护内容',   '0', 'admin', sysdate(), '', null, '管理员');
